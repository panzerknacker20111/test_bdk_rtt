...
bool_t
xdr_uint64(register XDR *xdrs, uint64_t *objp)
{
...
bool_t
xdr_int64(register XDR *xdrs, int64_t *objp)
{
...
bool_t
xdr_uint32(register XDR *xdrs, uint32_t *objp)
{
...
bool_t
xdr_int32(register XDR *xdrs, int32_t *objp)
{
