...
#endif
int32_t rt_vsprintf(char *dest, const char *format, va_list arg_ptr);
int32_t rt_vsnprintf(char *buf, rt_size_t size, const char *fmt, va_list args);
int32_t rt_sprintf(char *buf, const char *format, ...);
int32_t rt_snprintf(char *buf, rt_size_t size, const char *format, ...);
...
int32_t rt_strncmp(const char *cs, const char *ct, rt_ubase_t count);
int32_t rt_strcmp(const char *cs, const char *ct);
rt_size_t rt_strlen(const char *src);
char *rt_strdup(const char *s);

char *rt_strstr(const char *str1, const char *str2);
int32_t rt_sscanf(const char *buf, const char *fmt, ...);
char *rt_strncpy(char *dest, const char *src, rt_ubase_t n);
void *rt_memmove(void *dest, const void *src, rt_ubase_t n);
int32_t rt_memcmp(const void *cs, const void *ct, rt_ubase_t count);
