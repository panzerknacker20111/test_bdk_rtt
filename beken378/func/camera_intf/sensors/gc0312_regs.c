...
const uint8_t gc0312_init_table3[287][2] = {
    {0xfe, 0xf0},
    {0xfe, 0xf0},
    {0xfe, 0x00},
    {0xfc, 0x0e},
...
// Nota para Dani: {0xf3, 0xff} falta en una de las tablas y parece ser necesario para iniciar el stream

// From TXW817 SDK
#if 0
const uint8_t gc0312_init_table2[288][2] = {
    {0xfe, 0xf0},
    {0xfe, 0xf0},
    {0xfe, 0x00},
    {0xfc, 0x0e},
...
// From RK3308 SDK
#if 0
const uint8_t gc0312_init_table[287][2] =  {
	{0xfe, 0xf0},
	{0xfe, 0xf0},
	{0xfe, 0x00},
	{0xfc, 0x0e},
