...
extern void atsvr_cmd_rsp_passthrough(void);
extern void atsvr_cmd_rsp_busy(void);
...
extern unsigned int atsvr_input_msg_get_block(char *data,unsigned int data_len);
extern unsigned int atsvr_input_msg_get_block_one(char *data,unsigned int data_len);


extern void at_server_init(void);
extern void atsvr_network_init();
extern void atsvr_http_init();
