...
//Port P39-P32 Signal Map:bb_refclk rx_bit tx_bit sync_find vco_en pll_en trx_sw pwr_on
void rwip_diagnostic_init(void)
{
    ...
    *(volatile unsigned int *)(0x802800 + 0x37 * 4) = 0x40; //P39
    *(volatile unsigned int *)(0x802800 + 0x36 * 4) = 0x40; //P37
    *(volatile unsigned int *)(0x802800 + 0x35 * 4) = 0x40; //P37
    *(volatile unsigned int *)(0x802800 + 0x34 * 4) = 0x40; //P36
    *(volatile unsigned int *)(0x802800 + 0x33 * 4) = 0x40; //P35
    *(volatile unsigned int *)(0x802800 + 0x32 * 4) = 0x40; //P34
    *(volatile unsigned int *)(0x802800 + 0x31 * 4) = 0x40; //P33
    *(volatile unsigned int *)(0x802800 + 0x30 * 4) = 0x40; //P32
}
#endif
