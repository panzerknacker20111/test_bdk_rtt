...
typedef struct l2cap_chan_coc_cb
{
     ...
     ****************************************************************************************
     */
    void (*cb_sdu_rx) (uint8_t conidx, uint8_t chan_lid, uint16_t status, common_buf_t* p_sdu);
     ...
     ****************************************************************************************
     */
    void (*cb_sdu_sent) (uint8_t conidx, uint16_t dummy, uint8_t chan_lid, uint16_t status, common_buf_t* p_sdu);
 ...
 ****************************************************************************************
 */
uint16_t l2cap_chan_sdu_send(uint8_t conidx, uint16_t dummy, uint8_t chan_lid, uint8_t dbg_bf, common_buf_t* p_sdu);
