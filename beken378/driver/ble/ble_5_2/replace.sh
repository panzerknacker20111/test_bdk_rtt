...
find . -name *.h | xargs sed -i 's/\<MIC_LEN/BLE_MIC_LEN/g'
find . -name *.c | xargs sed -i 's/\<MIC_LEN/BLE_MIC_LEN/g'
find . -name *.h | xargs sed -i 's/\<IV_LEN/BLE_IV_LEN/g'
find . -name *.c | xargs sed -i 's/\<IV_LEN/BLE_IV_LEN/g'
find . -name *.h | xargs sed -i 's/\<SCAN_ACTIVE/BLE_SCAN_ACTIVE/g'
find . -name *.c | xargs sed -i 's/\<SCAN_ACTIVE/BLE_SCAN_ACTIVE/g'
find . -name *.h | xargs sed -i 's/\<SCAN_PASSIVE/BLE_SCAN_PASSIVE/g'
find . -name *.c | xargs sed -i 's/\<SCAN_PASSIVE/BLE_SCAN_PASSIVE/g'
find . -name *.h | xargs sed -i 's/\<MSG_T\>/BLE_MSG_T/g'
find . -name *.c | xargs sed -i 's/\<MSG_T\>/BLE_MSG_T/g'
find . -name *.c | xargs sed -i 's/\<MSG_I\>/BLE_MSG_I/g'
find . -name *.c | xargs sed -i 's/\<MSG_I\>/BLE_MSG_I/g'
